...
Issues live in this repo's GitHub Issues (`matheusdmlopes/skills-ptbr`), via the `gh` CLI. See [docs/agents/issue-tracker.md](./docs/agents/issue-tracker.md).
...
Single-context — `CONTEXT.md` at the root, ADRs in `.agents/adr/`. See [docs/agents/domain.md](./docs/agents/domain.md).
